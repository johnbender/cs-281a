...
Luckily, even if we consider a TQBF in every clause of the output CNF from the Cook Levin reduction we can treat it as a constant true or false value due to the TQBF oracle when verifying some assignment to the variables.
      \end{proof}
